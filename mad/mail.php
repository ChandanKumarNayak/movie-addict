...
$getdata=("SELECT * FROM `user` WHERE status='Credit' AND email_status='1'");
...
<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="mail.php">
...
<br>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter email">
						<input class="input100" type="text" name="email" placeholder="Enter email" value="<?php echo $row['email']; ?>" readonly>
						<span class="focus-input100" data-placeholder="&#xf223;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter subject">
						<input class="input100" type="text" name="subject" placeholder="Enter title" value="New Movie For You!" readonly>
						<span class="focus-input100" data-placeholder="&#xf223;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter content">
						<input class="input100" type="text" name="content" placeholder="Enter content" value="Click here:- https://www.movieaddict.xyz/user" readonly>
						<span class="focus-input100" data-placeholder="&#xf222;"></span>
					</div>


					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" value="Send Email">
							Send Email
						</button>
					</div>
...
include('db.php'); 
   ...
   {
  $query = "UPDATE user SET email_status= '0' WHERE email = '".$_POST["email"]."'";
  
  	mysqli_query($db, $query);
  	echo '<meta http-equiv="refresh" content="0;mail.php" />';
   }
