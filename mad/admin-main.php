...
function did(id)
{
     ...
     {
        window.location.href='admin-main.php?did='+id;
     }
}
</script>
...
<body style="background-image:url('../image/hello.jpg');background-repeat: repeat;background-size: 100% ;">
...
<center><input type="search" id="myInput" onkeyup="myFunction()" class="light-table-filter" placeholder="Search movie name..." /></center><br>
<!--===============================================Server Part================================================-->


<?php
include('db.php'); // Database Config
/* Delete Labour Detail Php  */
...
{
$did=$_GET['did'];
$sql="DELETE FROM movie WHERE id='$did'";	
if($result = mysqli_query($db, $sql)){
   

$msg="Link Deleted Successfully "; // Success Message
...
echo "<td><img src='images/".$row['myimage']."' style='width:100px;height:100px;border-radius:5px;margin:5px'></td>";
echo "<td>" . $row['star'] . "</td>";
...
echo '<td><a href="edit-post.php?id='.$row['id'].'"><button class="btn" name="update"><img border="0" alt="chandan" src="../image/edit.jpg" width="30" height="30" align="center"></button></a></td>';
echo '<td><a href="javascript:did('.$row['0'].')"><button class="btn"><img border="0" alt="chandan" src="../image/del.jpg" width="30" height="30" align="center"></button></a></td>';
echo "</tr>";
