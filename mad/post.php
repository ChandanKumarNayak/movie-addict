...
<br>
					...
					<div class="wrap-input100 validate-input" data-validate = "Upload image">
					<input class="input100" type="file" name="myimage" accept = "image/*" required>
					<span class="focus-input100" data-placeholder="&#xf223;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter subject">
						<input class="input100" type="text" name="subject" placeholder="Enter movie title" required>
						<span class="focus-input100" data-placeholder="&#xf223;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter starcast">
						<input class="input100" type="text" name="star" placeholder="Enter starcast" required>
						<span class="focus-input100" data-placeholder="&#xf223;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter details">
						<input class="input100" type="text" name="details" placeholder="Enter details" required>
						<span class="focus-input100" data-placeholder="&#xf223;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter content">
						<input class="input100" type="url" name="content" placeholder="Enter link1">
						<span class="focus-input100" data-placeholder="&#xf222;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter content">
						<input class="input100" type="url" name="content1" placeholder="Enter link2">
						<span class="focus-input100" data-placeholder="&#xf222;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter content">
						<input class="input100" type="url" name="content2" placeholder="Enter link3">
						<span class="focus-input100" data-placeholder="&#xf222;"></span>
					</div>
...
else
{
 ...
 if( in_array($imageFileType1,$extensions_arr1) )
  ...
  $query = "INSERT INTO movie (subject,star,details,content,content1,content2,myimage) 
  			  VALUES('$subject', '$star', '$details', '$content', '$content1', '$content2','$upload_image1')";
