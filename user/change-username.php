...
<br>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" placeholder="Current username" name="username_1" required>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" placeholder="New username" name="username_2" required>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="password" placeholder="Confirm username" name="username_3" required>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

<input type="hidden" name="id" value="<?php echo $eid ?>" />
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" name="update2">
							Update
						</button>
					</div>
...
{echo '<script language="javascript">alert("Current username is wrong.");</script>';}
 ...
 $username_2 = $_POST['username_2'];
  ...
  $sqluser="SELECT username FROM user WHERE username='$username_2' ";
  $qresult=mysqli_query($db, $sqluser);
  $count=mysqli_num_rows($qresult);
  if($count > 0)
  {
...
$sql="UPDATE `user` SET username='$username_2' WHERE username='".$_SESSION['username']."' AND username = '$username_1'";
