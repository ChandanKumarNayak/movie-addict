...
<html lang="en">
<head>
	<title>Signup | MovieAddict</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter fullname">
						<input class="input100" type="text" name="name" placeholder="Fullname" required>
...
if(isset($_POST['signup'])){
  ...
  if(count($error) == 0) 
	 ...
	 $query = "INSERT INTO user (name,email,username,password,purpose,amount,p_email,pid,status,email_status) VALUES ('$name','$email','$username','$password','0','0','0','0','0','0')";
