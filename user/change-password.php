...
<br>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" placeholder="Enter Current Username" name="username_1" required>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter password">
						<input class="input100" type="text" placeholder="Enter Current Password" name="password_1" required>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Enter password">
						<input class="input100" type="text" placeholder="Enter New Password" name="password_2" required>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate = "Enter password">
						<input class="input100" type="password" placeholder="Confirm New Password" name="password_3" required>
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
...
if(isset($_POST['update'])) // Get id
{
  ...
  $sqluser="SELECT username FROM user WHERE username='$username_1' ";
...
{echo '<script language="javascript">alert("Current username is wrong.");</script>';}
  ...
  $sqluser="SELECT password FROM user WHERE password='$password_1' ";
  $qresult=mysqli_query($db, $sqluser);
  $count=mysqli_num_rows($qresult);
   if($count == 0)
...
$sql="UPDATE `user` SET password='$password_3' WHERE username='$username_1' AND password = '$password_1'";	
