...
<html lang="en">
<head>
<title>Search | MovieAddict</title>
    <meta charset="UTF-8">
...
<center><input type="search" id="myInput" onkeyup="myFunction()" class="light-table-filter" placeholder="Type a movie name..." /></center><br>
<!--===============================================Server Part================================================-->
...
echo "<td><img src='../mad/images/".$row['myimage']."' style='width:100px;height:100px;border-radius:5px;margin:5px'></td>";
echo "<td>" . $row['star'] . "</td>";
echo '<td><a href="download.php?id='.$row['id'].'"><button class="btn" name="update"><img border="0" alt="chandan" src="images/download.jpg" width="100" height="35" align="center"></button></a></td>';
echo "</tr>";
