...
function did1(id)
{
     if(confirm('Sure To Delete Your Account From MovieAddict ?'))
     {
...
{
$did1=$_GET['did1'];
$sql="DELETE FROM user WHERE id='$did1'";	
...
<table>
<tr>
<th>Your account will be deleted permanently & you will no longer be able to access your "MovieAddict" account by using your current username & password.
						</th>
</tr>
<?php
include('db.php');
